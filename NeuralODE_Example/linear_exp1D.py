...
from plotter1D import plot_trajectories
...
if __name__ == '__main__':
    ...
    LinearFunctionExample = LinearODEF(Tensor([[-1.]]))
    RandomLinearODEF = LinearODEF(Tensor([[-0.5]]))
    ...
    for i in range(n_step):
        ...
        if i % plot_freq == 0:
            ...
            plot_trajectories(obs=[obs], times=[times], trajs=[z_p], save=f"imgs1D/{i}.png")
    ...
    plt.savefig('imgs1D/loss_graph.png')
    plt.close()
